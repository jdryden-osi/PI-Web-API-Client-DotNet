...
namespace OSIsoft.PIDevClub.PIWebApiClient.Model
{
	...
	public class PITimeRuleLinks
	{
		public PITimeRuleLinks(string Self = null, string Analysis = null, string AnalysisTemplate = null, string PlugIn = null)
		{
			this.Self = Self;
