...
namespace OSIsoft.PIDevClub.PIWebApiClient.Model
{
	...
	public class PISecurityIdentityLinks
	{
		public PISecurityIdentityLinks(string Self = null, string AssetServer = null, string SecurityMappings = null, string Security = null, string SecurityEntries = null)
		{
			this.Self = Self;
		...
		/// <summary>
		/// Gets or Sets PISecurityIdentityLinks
		/// </summary>
