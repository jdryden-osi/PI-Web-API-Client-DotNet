...
namespace OSIsoft.PIDevClub.PIWebApiClient.Api
{
	...
	public interface ITableCategoryApi
	{
		...
		System.Threading.Tasks.Task<PITableCategory> GetByPathAsync(string path, string selectedFields = null, string webIdType = null);
		...
		System.Threading.Tasks.Task<ApiResponse<PITableCategory>> GetByPathAsyncWithHttpInfo(string path, string selectedFields = null, string webIdType = null);
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>async System.Threading.Tasks.Task<PITableCategory></returns>
		System.Threading.Tasks.Task<PITableCategory> GetAsync(string webId, string selectedFields = null, string webIdType = null);
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>async System.Threading.Tasks.Task<ApiResponse<PITableCategory>></returns>
		System.Threading.Tasks.Task<ApiResponse<PITableCategory>> GetAsyncWithHttpInfo(string webId, string selectedFields = null, string webIdType = null);
		...
		System.Threading.Tasks.Task<Object> UpdateAsync(string webId, PITableCategory tableCategory);
		...
		System.Threading.Tasks.Task<ApiResponse<Object>> UpdateAsyncWithHttpInfo(string webId, PITableCategory tableCategory);
	...
	public class TableCategoryApi : ITableCategoryApi
	{
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>async System.Threading.Tasks.Task<PITableCategory></returns>
		public async System.Threading.Tasks.Task<PITableCategory> GetByPathAsync(string path, string selectedFields = null, string webIdType = null)
		{
			ApiResponse<PITableCategory> localVarResponse = await GetByPathAsyncWithHttpInfo(path, selectedFields, webIdType);
			return localVarResponse.Data;
		}
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>async System.Threading.Tasks.Task<ApiResponse<PITableCategory>></returns>
		public async System.Threading.Tasks.Task<ApiResponse<PITableCategory>> GetByPathAsyncWithHttpInfo(string path, string selectedFields = null, string webIdType = null)
		{
			// verify the required parameter 'path' is set
			if (path == null)
				throw new ApiException(400, "Missing required parameter 'path'");
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>async System.Threading.Tasks.Task<PITableCategory></returns>
		public async System.Threading.Tasks.Task<PITableCategory> GetAsync(string webId, string selectedFields = null, string webIdType = null)
		{
			ApiResponse<PITableCategory> localVarResponse = await GetAsyncWithHttpInfo(webId, selectedFields, webIdType);
			return localVarResponse.Data;
		}
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>async System.Threading.Tasks.Task<ApiResponse<PITableCategory>></returns>
		public async System.Threading.Tasks.Task<ApiResponse<PITableCategory>> GetAsyncWithHttpInfo(string webId, string selectedFields = null, string webIdType = null)
		{
			// verify the required parameter 'webId' is set
			if (webId == null)
				throw new ApiException(400, "Missing required parameter 'webId'");
		...
		/// <param name="tableCategory">A partial table category containing the desired changes.</param>
		/// <returns>async System.Threading.Tasks.Task<Object></returns>
		public async System.Threading.Tasks.Task<Object> UpdateAsync(string webId, PITableCategory tableCategory)
		{
			ApiResponse<Object> localVarResponse = await UpdateAsyncWithHttpInfo(webId, tableCategory);
			return localVarResponse.Data;
		}
		...
		/// <param name="tableCategory">A partial table category containing the desired changes.</param>
		/// <returns>async System.Threading.Tasks.Task<ApiResponse<Object>></returns>
		public async System.Threading.Tasks.Task<ApiResponse<Object>> UpdateAsyncWithHttpInfo(string webId, PITableCategory tableCategory)
		{
			// verify the required parameter 'webId' is set
			if (webId == null)
				throw new ApiException(400, "Missing required parameter 'webId'");
